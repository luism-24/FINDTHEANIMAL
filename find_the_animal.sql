...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2023 a las 02:30:32
...
CREATE TABLE `animal` (
  ...
  `Descrianimal` varchar(50) NOT NULL,
...
(1, 'Candy', 'gato1.png', 'Tiene 2 años y es color naranja', 2, 1, 1),
(2, 'Bigote', 'gato2.png', 'Gato hermoso', 2, 2, 2),
(3, 'Max', 'cockerspaniel.png', 'Tiene menos de un año, lo encontré por los lados d', 5, 2, 3),
(4, 'Princesa', 'Husky.png', 'Ella es Naya, se perdió por los lados de Copac', 4, 1, 7),
(5, 'Naya', 'Pastorovejero.png', 'Ella es Danna, fue vista por el centro comercial P', 3, 1, 4);
...
CREATE TABLE `empresa` (
  ...
  `Descriempresa` varchar(50) NOT NULL,
...
INSERT INTO `empresa` (`Idempresa`, `Descriempresa`, `Direcempre`, `Fotoempre`, `Encargadoempre`, `Telefonoempre`, `Correoempre`, `Contraseñaempre`, `IdTiempre`) VALUES
(18274634928376, 'Somos una clínica veterinaria que realiza todo tip', 'Cl 65 #87-59', 'Veterinariarobledo.png', 'Manuel Duque', '3145672349', 'Vetrobledo@gmaail.com', 'Robledoveterinaria', 2),
(19338473624875, 'PET boutique es un spa para mascotas que presta to', 'Cl. 50 #47 15', 'PETboutique.png', 'Sandra Restrespo', '3675312345', 'PETboutique.spa@gmail.com', 'Spa2023', 1),
(28374651264783, 'Compra increíbles accesorios para tu mascota. Coll', 'Cl. 1A ##53-21', 'Supercan.png', 'Claudia Chavarría', '3876745627', 'Supercannegocio@gmail.com', 'Perritos123', 1),
...
(38756473827450, 'Somos un grupo privado sin animo de lucro, dirigid', 'Caldas Sur', 'Losangeles.png', 'Angela Patricia Reyes', '3013936074', 'losangelescaninos@une.net.co', 'LosAngelesperritos', 3);
...
--
ALTER TABLE `raza`
  MODIFY `Idraza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tipousuario`
  MODIFY `IdTiusua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
