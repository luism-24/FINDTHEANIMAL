...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-text" data-aos="zoom-out" style="margin-top: 15%;">
      <h2 class="Sombra" style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Bienvenid@ a Find The Animal</h2>
      <p class="Sombra">Somos la mejor opción para ayudar a los animales</p>
      <a href="registrate.php" class="btn-get-started scrollto, Sombra" style="width: 20%; height: 20%; font-size: 140%;">Regístrate</a>
    </div>
