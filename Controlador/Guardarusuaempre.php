...
include ('conex.php');
   ...
   if(isset($_POST['BtnGuardar'])) {
	...
	$ins= "INSERT INTO empresa (Idempresa ,Descriempresa, Direcempre, Fotoempre, Encargadoempre, Telefonoempre,  Correoempre, Contraseñaempre, IdTiempre)
	VALUES ('$Idempresa','$Descriempresa','$Direcempre','$Fotoempre','$Encargadoempre','$Telefonoempre','$Correoempre','$Contraseñaempre','$IdTiempre')";
